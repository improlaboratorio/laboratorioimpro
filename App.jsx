...
export default function AsistenciaApp() {
  ...
  return (
    <div className="app-shell" style={{ minHeight: "100vh", background: T.paper, fontFamily: "system-ui, sans-serif", color: T.ink }}>
      <style>{`
    ...
    <div>
      ...
      {pickerDate && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(10,10,10,0.45)", display: "flex", alignItems: "flex-end", justifyContent: "center", zIndex: 50 }} onClick={() => setPickerDate(null)}>
          <div className="modal-sheet-pad" style={{ background: "#fff", borderRadius: "16px 16px 0 0", width: "100%", maxWidth: 420, padding: 20 }} onClick={(e) => e.stopPropagation()}>

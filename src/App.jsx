  ...
  return (
    <div className="app-shell" style={{ minHeight: "100vh", background: `linear-gradient(180deg, ${T.accentDim} 0%, ${T.paper} 220px)`, fontFamily: "system-ui, sans-serif", color: T.ink }}>
      ...
      <header style={{ background: "#fff", boxShadow: "0 1px 2px rgba(10,10,10,0.04), 0 8px 20px -12px rgba(10,10,10,0.15)", padding: "14px 12px 0" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative", display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12, minHeight: 64 }}>
          ...
          <img src={LOGO_SRC} alt="Laboratorio Impro" className="app-header-logo" style={{ height: 64, width: "auto", flexShrink: 0, position: "absolute", left: "50%", top: 0, transform: "translateX(-50%)" }} />
        </div>
